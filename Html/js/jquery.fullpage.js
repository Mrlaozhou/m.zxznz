 ...
 */
! function(e, n) { "use strict"; "function" == typeof define && define.amd ? define(["jquery"], function(o) {
        return n(o, e, e.document, e.Math) }) : "undefined" != typeof exports ? module.exports = n(require("jquery"), e, e.document, e.Math) : n(jQuery, e, e.document, e.Math) }("undefined" != typeof window ? window : this, function(e, n, o, t, i) { "use strict";
    ...
    e.fn.fullpage = function(s) {
        function c() { s.css3 && (s.css3 = en()), s.anchors.length || (s.anchors = e(s.sectionSelector + "[data-anchor]").map(function() {
                return e(this).data("anchor").toString() }).get()), f(), Sn.setAllowScrolling(!0), An = ee.height(), Sn.setAutoScrolling(s.autoScrolling, "internal");
            var n = e(b).find(O);
            n.length && (0 !== e(b).index(x) || 0 === e(b).index(x) && 0 !== n.index()) && sn(n), Fe(), _e(), ee.on("load", function() { ke() }) }

        function f() { kn.css({ height: "100%", position: "relative" }), kn.addClass(r), e("html").addClass(v), kn.removeClass(p), J(), e(x).each(function(n) {
                var o = e(this),
                    t = o.find(q),
                    i = t.length;
                X(o, n), j(o, n), i > 0 ? d(o, t, i) : s.verticalCentered && Ye(o) }), s.fixedElements && s.css3 && e(s.fixedElements).appendTo(gn), s.navigation && oe(), s.scrollOverflow ? ("complete" === o.readyState && te(), ee.on("load", te)) : ie() }

        function d(n, o, t) {
            var i = 100 * t,
                a = 100 / t;
            o.wrapAll('<div class="' + I + '" />'), o.parent().wrap('<div class="' + z + '" />'), n.find(P).css("width", i + "%"), t > 1 && (s.controlArrows && Z(n), s.slidesNavigation && Ge(n, t)), o.each(function(n) { e(this).css("width", a + "%"), s.verticalCentered && Ye(e(this)) });
            var r = n.find(O);
            r.length && (0 !== e(b).index(x) || 0 === e(b).index(x) && 0 !== r.index()) ? sn(r) : o.eq(0).addClass(g) }

        function X(n, o) { o || 0 !== e(b).length || n.addClass(g), n.css("height", An + "px"), s.paddingTop && n.css("padding-top", s.paddingTop), s.paddingBottom && n.css("padding-bottom", s.paddingBottom), "undefined" != typeof s.sectionsColor[o] && n.css("background-color", s.sectionsColor[o]), "undefined" != typeof s.anchors[o] && n.attr("data-anchor", s.anchors[o]) }

        function j(n, o) { "undefined" != typeof s.anchors[o] && n.hasClass(g) && Ie(s.anchors[o], o), s.menu && s.css3 && e(s.menu).closest(l).length && e(s.menu).appendTo(gn) }

        function J() { e(s.sectionSelector).each(function() { e(this).addClass(y) }), e(s.slideSelector).each(function() { e(this).addClass(H) }) }

        function Z(e) { e.find(D).after('<div class="' + Q + '"></div><div class="' + $ + '"></div>'), "#fff" != s.controlArrowColor && (e.find(_).css("border-color", "transparent transparent transparent " + s.controlArrowColor), e.find(G).css("border-color", "transparent " + s.controlArrowColor + " transparent transparent")), s.loopHorizontal || e.find(G).hide() }

        function oe() { gn.append('<div id="' + L + '"><ul></ul></div>');
            var n = e(E);
            n.addClass(function() {
            ...
            for (var o = 0; o < e(x).length; o++) {
                ...
                var i = '<li><a href="#' + t + '"><span></span></a>',
                    a = s.navigationTooltips[o]; "undefined" != typeof a && "" !== a && (i += '<div class="' + B + " " + s.navigationPosition + '">' + a + "</div>"), i += "</li>", n.find("ul").append(i) }
            e(E).css("margin-top", "-" + e(E).height() / 2 + "px"), e(E).find("li").eq(e(b).index(x)).find("a").addClass(g) }

        function te() { e(x).each(function() {
                var n = e(this).find(q);
                n.length ? n.each(function() { We(e(this)) }) : We(e(this)) }), ie() }
        ...
        function ae() {
            ...
            if (!s.autoScrolling || s.scrollBar) {
                for (var i = ee.scrollTop(), a = 0, r = t.abs(i - o.querySelectorAll(x)[0].offsetTop), l = o.querySelectorAll(x), c = 0; c < l.length; ++c) {
                    ...
                    r > d && (a = c, r = d) }
                if (n = e(l).eq(a), !n.hasClass(g) && !n.hasClass(M)) { Pn = !0;
                    var u = e(b),
                        h = u.index(x) + 1,
                        p = Pe(n),
                        v = n.data("anchor"),
                    ...
                    if (S.length) var w = S.data("anchor"),
                        y = S.index();
                    En && (n.addClass(g).siblings().removeClass(g), e.isFunction(s.onLeave) && s.onLeave.call(u, h, m, p), e.isFunction(s.afterLoad) && s.afterLoad.call(n, v, m), xe(n), Ie(v, m - 1), s.anchors.length && (wn = v, Je(y, w, v, m))), clearTimeout(On), On = setTimeout(function() { Pn = !1 }, 100) }
                s.fitToSection && (clearTimeout(zn), zn = setTimeout(function() { En && s.fitToSection && (e(b).is(n) && requestAnimFrame(function() { Mn = !0 }), ve(n), requestAnimFrame(function() { Mn = !1 })) }, s.fitToSectionDelay)) } }
        ...
        function le(o) {
            ...
            if (!se(o.target) && ce(i)) { s.autoScrolling && o.preventDefault();
                var a = e(b),
        ...
        function ue(o) {
            ...
            if (s.autoScrolling && !xn) { o = o || n.event;
        ...
        function pe() { e(O).each(function() { sn(e(this), "internal") }) }

        function ve(n, o, t) { requestAnimFrame(function() {
                var i = n.position();
                if ("undefined" != typeof i) {
                    var a = n.hasClass(M) && i.top ? i.top - An + n.height() : i.top,
                        r = { element: n, callback: o, isMovementUp: t, dest: i, dtop: a, yMovement: Pe(n), anchorLink: n.data("anchor"), sectionIndex: n.index(x), activeSlide: n.find(O), activeSection: e(b), leavingSection: e(b).index(x) + 1, localIsResizing: Mn };
        ...
        function me(n) {
            if (s.css3 && s.autoScrolling && !s.scrollBar) {
                ...
                Xe(o, !0), s.scrollingSpeed ? Hn = setTimeout(function() { ye(n) }, s.scrollingSpeed) : ye(n) } else {
                var t = ge(n);
                e(t.element).animate(t.options, s.scrollingSpeed, s.easing).promise().done(function() { ye(n) }) } }
        ...
        function we(n) { n.wrapAroundElements && n.wrapAroundElements.length && (n.isMovementUp ? e(T).before(n.wrapAroundElements) : e(C).after(n.wrapAroundElements), cn(e(b).position().top), pe()) }

        function ye(n) { we(n), n.element.find(".fp-scrollable").mouseover(), e.isFunction(s.afterLoad) && !n.localIsResizing && s.afterLoad.call(n.element, n.anchorLink, n.sectionIndex + 1), be(n.element), En = !0, e.isFunction(n.callback) && n.callback.call(this) }
        ...
        function Me(n) { clearTimeout(Dn);
            var o = e(":focus");
            if (!o.is("textarea") && !o.is("input") && !o.is("select") && s.keyboardScrolling && s.autoScrolling) {
                var t = n.which,
                    i = [40, 38, 32, 33, 34];
                e.inArray(t, i) > -1 && n.preventDefault(), xn = n.ctrlKey, Dn = setTimeout(function() { Le(n) }, 150) } }
        ...
        function Ee(e) { En && (e.pageY < Nn ? Sn.moveSectionUp() : e.pageY > Nn && Sn.moveSectionDown()), Nn = e.pageY }
        ...
        function Be(n, o) {
            ...
            var m = function() { h || e.isFunction(s.afterSlideLoad) && s.afterSlideLoad.call(o, c, l + 1, d, a), be(o), bn = !1 };
            if (s.css3) {
                var w = "translate3d(-" + t.round(i.left) + "px, 0px, 0px)";
                He(n.find(P), s.scrollingSpeed > 0).css(fn(w)), qn = setTimeout(function() { m() }, s.scrollingSpeed, s.easing) } else n.animate({ scrollLeft: t.round(i.left) }, s.scrollingSpeed, s.easing, function() { m() });
        ...
        function Re() {
            if (Fe(), Tn) {
                ...
                if (!n.is("textarea") && !n.is("input") && !n.is("select")) {
                    var i = ee.height();
                    t.abs(i - Kn) > 20 * t.max(Kn, i) / 100 && (Sn.reBuild(!0), Kn = i) } } else clearTimeout(Fn), Fn = setTimeout(function() { Sn.reBuild(!0) }, 350) }
        ...
        function Oe(e, n) {
            ...
            if (o > e || i > n) {
                var a = 100 * e / o,
                    ...
                    l = t.min(a, r),
                    s = l.toFixed(2);
                gn.css("font-size", s + "%") } else gn.css("font-size", "100%") }

        function ze(n, o) { s.navigation && (e(E).find(S).removeClass(g), n ? e(E).find('a[href="#' + n + '"]').addClass(g) : e(E).find("li").eq(o).find("a").addClass(g)) }

        function De(n) { s.menu && (e(s.menu).find(S).removeClass(g), e(s.menu).find('[data-menuanchor="' + n + '"]').addClass(g)) }

        function Ie(e, n) { De(e), ze(e, n) }
        ...
        function We(e) { e.css("overflow", "hidden");
        ...
        function Ye(e) { e.addClass(V).wrapInner('<div class="' + k + '" style="height:' + Ue(e) + 'px;" />') }
        ...
        function Xe(e, n) { n ? He(kn) : qe(kn), kn.css(fn(e)), setTimeout(function() { kn.removeClass(h) }, 10) }
        ...
        function je(e, n) {
            var o = Ne(e); "undefined" == typeof n && (n = 0), e === wn || o.hasClass(g) ? Qe(o, n) : ve(o, function() { Qe(o, n) }) }
        ...
        function Ge(e, n) { e.append('<div class="' + W + '"><ul></ul></div>');
            var o = e.find(Y);
        ...
        function nn() { o.addEventListener ? (o.removeEventListener("mousewheel", ue, !1), o.removeEventListener("wheel", ue, !1), o.removeEventListener("MozMousePixelScroll", ue, !1)) : o.detachEvent("onmousewheel", ue) }

        function on() {
            var e, t = "";
            n.addEventListener ? e = "addEventListener" : (e = "attachEvent", t = "on");
            var a = "onwheel" in o.createElement("div") ? "wheel" : o.onmousewheel !== i ? "mousewheel" : "DOMMouseScroll"; "DOMMouseScroll" == a ? o[e](t + "MozMousePixelScroll", ue, !1) : o[e](t + a, ue, !1) }
        ...
        function sn(e, n) { Sn.setScrollingSpeed(0, "internal"), "undefined" != typeof n && (Mn = !0), Be(e.closest(D), e), "undefined" != typeof n && (Mn = !1), Sn.setScrollingSpeed(In.scrollingSpeed, "internal") }

        function cn(e) {
            if (s.scrollBar) kn.scrollTop(e);
            else if (s.css3) {
                var n = "translate3d(0px, -" + e + "px, 0px)";
                Xe(n, !1) } else kn.css("top", -e) }
        ...
        function un() { cn(0), e(E + ", " + Y + ", " + N).remove(), e(x).css({ height: "", "background-color": "", padding: "" }), e(q).css({ width: "" }), kn.css({ height: "", position: "", "-ms-touch-action": "", "touch-action": "" }), mn.css({ overflow: "", height: "" }), e("html").removeClass(v), e.each(gn.get(0).className.split(/\s+/), function(e, n) { 0 === n.indexOf(m) && gn.removeClass(n) }), e(x + ", " + q).each(function() { s.scrollOverflowHandler.remove(e(this)), e(this).removeClass(V + " " + g) }), qe(kn), kn.find(A + ", " + P + ", " + D).each(function() { e(this).replaceWith(this.childNodes) }), mn.scrollTop(0);
            var n = [y, H, I];
            e.each(n, function(n, o) { e("." + o).removeClass(o) }) }

        function hn(e, n, o) { s[e] = n, "internal" !== o && (In[e] = n) }

        function pn() { s.continuousVertical && (s.loopTop || s.loopBottom) && (s.continuousVertical = !1, vn("warn", "Option `loopTop/loopBottom` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled")), s.scrollBar && s.scrollOverflow && vn("warn", "Option `scrollBar` is mutually exclusive with `scrollOverflow`. Sections with scrollOverflow might not work well in Firefox"), s.continuousVertical && s.scrollBar && (s.continuousVertical = !1, vn("warn", "Option `scrollBar` is mutually exclusive with `continuousVertical`; `continuousVertical` disabled")), e.each(s.anchors, function(n, o) {
        ...
        function vn(e, n) { console && console[e] && console[e]("fullPage: " + n) }
        var mn = e("html, body"),
            gn = e("body"),
            Sn = e.fn.fullpage;
        s = e.extend({ menu: !1, anchors: [], lockAnchors: !1, navigation: !1, navigationPosition: "right", navigationTooltips: [], showActiveTooltip: !1, slidesNavigation: !1, slidesNavPosition: "bottom", scrollBar: !1, css3: !0, scrollingSpeed: 700, autoScrolling: !0, fitToSection: !0, fitToSectionDelay: 1e3, easing: "easeInOutCubic", easingcss3: "ease", loopBottom: !1, loopTop: !1, loopHorizontal: !0, continuousVertical: !1, normalScrollElements: null, scrollOverflow: !1, scrollOverflowHandler: a, touchSensitivity: 5, normalScrollElementTouchThreshold: 5, keyboardScrolling: !0, animateAnchor: !0, recordHistory: !0, controlArrows: !0, controlArrowColor: "#fff", verticalCentered: !0, resize: !1, sectionsColor: [], paddingTop: 0, paddingBottom: 0, fixedElements: null, responsive: 0, responsiveWidth: 0, responsiveHeight: 0, sectionSelector: w, slideSelector: F, afterLoad: null, onLeave: null, afterRender: null, afterResize: null, afterReBuild: null, afterSlideLoad: null, onSlideLeave: null }, s), pn(), e.extend(e.easing, { easeInOutCubic: function(e, n, o, t, i) {
                return (n /= i / 2) < 1 ? t / 2 * n * n * n + o : t / 2 * ((n -= 2) * n * n + 2) + o } }), e.extend(e.easing, { easeInQuart: function(e, n, o, t, i) {
                return t * (n /= i) * n * n * n + o } }), Sn.setAutoScrolling = function(n, o) { hn("autoScrolling", n, o);
            var t = e(b);
            s.autoScrolling && !s.scrollBar ? (mn.css({ overflow: "hidden", height: "100%" }), Sn.setRecordHistory(In.recordHistory, "internal"), kn.css({ "-ms-touch-action": "none", "touch-action": "none" }), t.length && cn(t.position().top)) : (mn.css({ overflow: "visible", height: "initial" }), Sn.setRecordHistory(!1, "internal"), kn.css({ "-ms-touch-action": "", "touch-action": "" }), cn(0), t.length && mn.scrollTop(t.position().top)) }, Sn.setRecordHistory = function(e, n) { hn("recordHistory", e, n) }, Sn.setScrollingSpeed = function(e, n) { hn("scrollingSpeed", e, n) }, Sn.setFitToSection = function(e, n) { hn("fitToSection", e, n) }, Sn.setLockAnchors = function(e) { s.lockAnchors = e }, Sn.setMouseWheelScrolling = function(e) { e ? on() : nn() }, Sn.setAllowScrolling = function(n, o) { "undefined" != typeof o ? (o = o.replace(/ /g, "").split(","), e.each(o, function(e, o) { dn(n, o, "m") })) : n ? (Sn.setMouseWheelScrolling(!0), tn()) : (Sn.setMouseWheelScrolling(!1), an()) }, Sn.setKeyboardScrolling = function(n, o) { "undefined" != typeof o ? (o = o.replace(/ /g, "").split(","), e.each(o, function(e, o) { dn(n, o, "k") })) : s.keyboardScrolling = n }, Sn.moveSectionUp = function() {
            var n = e(b).prev(x);
            n.length || !s.loopTop && !s.continuousVertical || (n = e(x).last()), n.length && ve(n, null, !0) }, Sn.moveSectionDown = function() {
            var n = e(b).next(x);
            n.length || !s.loopBottom && !s.continuousVertical || (n = e(x).first()), n.length && ve(n, null, !1) }, Sn.silentMoveTo = function(e, n) { requestAnimFrame(function() { Sn.setScrollingSpeed(0, "internal") }), Sn.moveTo(e, n), requestAnimFrame(function() { Sn.setScrollingSpeed(In.scrollingSpeed, "internal") }) }, Sn.moveTo = function(e, n) {
            var o = Ne(e); "undefined" != typeof n ? je(e, n) : o.length > 0 && ve(o) }, Sn.moveSlideRight = function(e) { he("next", e) }, Sn.moveSlideLeft = function(e) { he("prev", e) }, Sn.reBuild = function(o) {
            if (!kn.hasClass(p)) { Mn = !0, requestAnimFrame(function() { Mn = !0 });
                var t = n.outerWidth;
                An = ee.height(), s.resize && Oe(An, t), e(x).each(function() {
                    var n = e(this).find(D),
                        o = e(this).find(q);
                    s.verticalCentered && e(this).find(A).css("height", Ue(e(this)) + "px"), e(this).css("height", An + "px"), s.scrollOverflow && (o.length ? o.each(function() { We(e(this)) }) : We(e(this))), o.length > 1 && Be(n, n.find(O)) });
                var i = e(b),
                    a = i.index(x);
                a && Sn.silentMoveTo(a + 1), Mn = !1, requestAnimFrame(function() { Mn = !1 }), e.isFunction(s.afterResize) && o && s.afterResize.call(kn), e.isFunction(s.afterReBuild) && !o && s.afterReBuild.call(kn) } }, Sn.setResponsive = function(n) {
            var o = gn.hasClass(u);
        ...
        var wn, yn, xn, bn = !1,
            ...
            Bn = [],
            Rn = {};
        Rn.m = { up: !0, down: !0, left: !0, right: !0 }, Rn.k = e.extend(!0, {}, Rn.m);
        ...
        n.requestAnimFrame = function() {
            return n.requestAnimationFrame || n.webkitRequestAnimationFrame || n.mozRequestAnimationFrame || n.oRequestAnimationFrame || n.msRequestAnimationFrame || function(e) { e() } }(), ee.on("hashchange", Ae), ne.keydown(Me), ne.keyup(function(e) { Ln && (xn = e.ctrlKey) }), e(n).blur(function() { Ln = !1, xn = !1 });
        var Dn;
        kn.mousedown(function(e) { 2 == e.which && (Nn = e.pageY, kn.on("mousemove", Ee)) }), kn.mouseup(function(e) { 2 == e.which && kn.off("mousemove") });
        var Nn = 0;
        ne.on("click touchstart", E + " a", function(n) { n.preventDefault();
            var o = e(this).parent().index();
            ve(e(x).eq(o)) }), ne.on("click touchstart", U, function(n) { n.preventDefault();
            var o = e(this).closest(x).find(D),
                t = o.find(q).eq(e(this).closest("li").index());
            Be(o, t) }), s.normalScrollElements && (ne.on("mouseenter", s.normalScrollElements, function() { Sn.setMouseWheelScrolling(!1) }), ne.on("mouseleave", s.normalScrollElements, function() { Sn.setMouseWheelScrolling(!0) })), e(x).on("click touchstart", N, function() {
            var n = e(this).closest(x);
            e(this).hasClass(K) ? Rn.m.left && Sn.moveSlideLeft(n) : Rn.m.right && Sn.moveSlideRight(n) }), ee.resize(Re);
        var Kn = An;
        Sn.destroy = function(n) { Sn.setAutoScrolling(!1, "internal"), Sn.setAllowScrolling(!1), Sn.setKeyboardScrolling(!1), kn.addClass(p), clearTimeout(qn), clearTimeout(Hn), clearTimeout(Fn), clearTimeout(On), clearTimeout(zn), ee.off("scroll", ae).off("hashchange", Ae).off("resize", Re), ne.off("click", E + " a").off("mouseenter", E + " li").off("mouseleave", E + " li").off("click", U).off("mouseover", s.normalScrollElements).off("mouseout", s.normalScrollElements), e(x).off("click", N), clearTimeout(qn), clearTimeout(Hn), n && un() } };
    var oe = { afterRender: function(e) {
            var n = e.find(z),
                o = e.find(c);
            n.length && (o = n.find(O)), o.mouseover() }, create: function(e, n) { e.find(c).slimScroll({ allowPageScroll: !0, height: n + "px", size: "10px", alwaysVisible: !0 }) }, isScrolled: function(e, n) {
            return "top" === e ? !n.scrollTop() : "bottom" === e ? n.scrollTop() + 1 + n.innerHeight() >= n[0].scrollHeight : void 0 }, scrollable: function(e) {
            return e.find(D).length ? e.find(O).find(c) : e.find(c) }, scrollHeight: function(e) {
            return e.find(c).get(0).scrollHeight }, remove: function(e) { e.find(c).children().first().unwrap().unwrap(), e.find(f).remove(), e.find(d).remove() }, update: function(e, n) { e.find(c).css("height", n + "px").parent().css("height", n + "px") }, wrapContent: function() {
